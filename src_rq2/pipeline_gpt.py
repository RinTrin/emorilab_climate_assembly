...
# from calc_similarity_gpt_money import select_similar_sentence
...
def pipeline(city_name=None):
    ...
    input_sentences_pkl = get_sentences_annotated(city_name, mode="inputmaterial", refresh_pickle=False)  # ← マージ後TXTを使って分割
    ...
    #     # model_pick="gpt-5.4-2026-03-05",
    #     # model_na="gpt-5.4-2026-03-05",
    #     # model_rank="gpt-5.4-2026-03-05",
